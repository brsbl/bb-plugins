...
Treat the plugin workspace manifests as the repository inventory and keep user-facing plugin documentation short. Preserve stable package/plugin IDs for the remaining plugins, including `prompt-shaper`, while using their user-facing display names.
