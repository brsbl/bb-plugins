...
type LegacyOriginFields = { childOrigin?: unknown };
...
export function isManageableThread(thread: OrganizableThread): boolean {
  const legacy = thread as OrganizableThread & LegacyOriginFields;
  return (
    thread.visibility === "visible" &&
    thread.parentThreadId === null &&
    thread.sourceThreadId === null &&
    thread.originKind === null &&
    legacy.childOrigin !== "fork" &&
    legacy.childOrigin !== "side-chat" &&
