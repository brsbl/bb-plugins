...
var handoffListeners = /* @__PURE__ */ new Set();
...
function requestTimelineCommentHandoff(threadId) {
  for (const listener of handoffListeners) listener(threadId);
}
function subscribeTimelineCommentHandoff(listener) {
