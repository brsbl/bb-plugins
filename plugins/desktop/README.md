...
- **Games.** Minesweeper (Beginner, Intermediate, Expert; first click is always safe, right-click to flag, click a number to open around it) and Solitaire (Klondike, draw one; drag cards, click the stock to draw, double-click to send a card home), and Pinball (Z and / flip, hold Space to pull the plunger, X nudges, F2 starts a new game) live under Games in the Start menu and can be added to Quick Launch.
