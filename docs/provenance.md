...
The vendored `@bb/plugin-sdk` testing archive and the lightweight BB 0.0.34 plugin builder come from official bb commit `50b7502301573ef296fbf0e2bfaa2ffad9678aaa`; their exact hashes are recorded in `tooling/vendor/sdk-provenance.json` and `tooling/vendor/plugin-build-provenance.json`.
